...
int main(){
        ...
        for(i=0;i<n;i++){
                ...
                if(p[i].period*p[i].runtimes_left > end)
                        end = p[i].period*p[i].runtimes_left; //end = maximum time till all these processes will run
